    ...
    describe('package.json', function () {
        ...
        describe('package.json JSON data', function () {
            it('must have valid name, description and author', function () {
                expect(json.name).to.equal('generic-bitmask');
                expect(json.description)
                  .to.equal('Module to compute and manipulate bitmasks in JavaScript');
        ...
        describe('script definitions', function () {
            ...
            it.skip('must have the hashbang defined', function () {
                var fileContent,
                  prop;
